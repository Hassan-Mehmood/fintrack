...
Components live in `components/ui/`. Add generated components using the shadcn CLI and do not modify generated components unless explicitly required. Build feature-specific wrappers inside the relevant feature folder.
