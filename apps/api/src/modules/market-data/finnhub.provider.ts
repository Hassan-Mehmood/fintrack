        ...
        this.withQuotePermit(async () => {
          ...
          return [
            providerAssetId,
            {
              ...
              priceType: 'CURRENT' as const,
              providerDate: null,
              providerMarketAt,
              fetchedAt,
              open: null,
              high: typeof payload.h === 'number' ? String(payload.h) : null,
              low: typeof payload.l === 'number' ? String(payload.l) : null,
              close: String(payload.c),
              adjustedClose: null,
              change: typeof payload.d === 'number' ? String(payload.d) : null,
              changePercent:
